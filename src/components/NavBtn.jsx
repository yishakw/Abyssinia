...
function NavBtn({ title, delay, clas }) {
  ...
  return (
    <motion.li
      className={`${clas} list-none  mx-1 s:mx-3 flex justify-center w-[95%] lg:w-fit lg:my-0 cursor-pointer border-b border-transparent hover:border-b hover:border-slate-500 hover:border-opacity-70 md:hover:border-transparent `}
